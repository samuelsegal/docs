//This is my first attempt just to get it to work, however it does not pass `linear time and constant space` requirement also it does not consider negatives which is no bueno for performance.
//const arr = [3, 4, -1, 1, 3];
(function() {
	const arr = [1, 2, 0];
	//sort the arr
